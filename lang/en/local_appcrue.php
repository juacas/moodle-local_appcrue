...
$string['lmsappcrue:enable_calendar'] = 'Enable calendar endpoint';
$string['lmsappcrue:enable_calendar_help'] = 'Enable calendar endpoint to share the user calendar with AppCRUE.';
...
$string['share_course_events_help'] = 'Include course-level events in the response.';
$string['share_site_events'] = 'Return the institution\'s events';
$string['share_site_events_help'] = 'Include institution\'s events in the response.';
$string['share_user_events'] = 'Return personal events';
$string['share_user_events_help'] = 'Include personal events in the response.';
