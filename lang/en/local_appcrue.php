...
$string['idp_use_custom_idp'] = 'Use custom IdP';
$string['idp_use_custom_idp_help'] = 'If enabled, a custom Identity Provider endpoint will be used to validate the tokens provided by AppCrue. The custom IdP must implement an OAuth2 token introspection endpoint that returns user identity information in JSON format. If disabled, the default AppCrue IdP will be used.';
