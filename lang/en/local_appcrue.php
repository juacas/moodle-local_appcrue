...
$string['lmsappcrue:api_authorized_networks'] = 'API authorithed networks';
$string['lmsappcrue:api_authorized_networks_help'] = 'List of networks that are allowed to access the LMS API. It is a line separated list of IP addresses or CIDR notation.';
