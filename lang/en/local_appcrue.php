...
$string['autologin:deep_url_token_mark'] = 'Deep URL token mark';
$string['autologin:deep_url_token_mark_bearer'] = 'bearer';
$string['autologin:deep_url_token_mark_disabled'] = 'No deep URLs';
...
$string['lmsappcrue:forums'] = 'LMS AppCRUE forums';
