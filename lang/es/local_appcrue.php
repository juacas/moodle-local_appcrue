...
$string['lmsappcrue:api_key_warning'] = 'Un sistema remoto usó una clave api_key desconocida "{$a}" mientras accedía al endpoint de rotación de clave API. Si estás configurando la clave API por primera vez o la has perdido, si confías en los servicios con acceso al endpoint (p.ej. por los filtros de red), puedes usar este valor para configurarla en los ajustes del plugin.';
